...
from reporting._ifrs7_sections_a import (
    _build_35f, _build_35h, _build_35i, _build_35j,
)
from reporting._ifrs7_sections_b import (
    _build_35k, _build_35l, _build_35m, _build_36,
)
...
def generate_ifrs7_disclosure(project_id: str, user: str = "system") -> dict:
    ...
    return {"report_id": report_id, "status": "draft", "report_type": "ifrs7_disclosure",
