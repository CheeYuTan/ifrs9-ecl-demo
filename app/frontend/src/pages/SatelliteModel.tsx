          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-semibold transition ${
                showRunHistory ? 'bg-indigo-100 text-indigo-700' : 'bg-slate-100 text-slate-600 hover:bg-slate-200 dark:hover:bg-slate-600'
              }`}
            >
                ...
                return (
                  <div key={run.run_id}
                    className={`flex items-center justify-between p-3 rounded-lg border transition ${
                      isActive ? 'bg-indigo-50 border-indigo-200' : 'bg-slate-50 border-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700'
                    }`}>
