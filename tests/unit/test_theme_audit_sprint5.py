"""
Sprint 5 Theme Audit — Regression Tests

Verify that the 13 Sprint 5 admin sub-page and stress-testing .tsx files
have no dark-mode-only Tailwind CSS violations. Reuses the 16 scanner
functions from Sprint 1.

Sprint 5 Files (6 admin sub-pages):
  - pages/admin/AdminAppSettings.tsx
  - pages/admin/AdminDataMappings.tsx
  - pages/admin/AdminModelConfig.tsx
  - pages/admin/AdminSystemConfig.tsx
  - pages/admin/AdminThemeConfig.tsx
  - pages/admin/AdminJobsConfig.tsx

Sprint 5 Files (7 stress-testing tabs):
  - pages/stress-testing/index.tsx
  - pages/stress-testing/SensitivityTab.tsx
  - pages/stress-testing/MonteCarloTab.tsx
  - pages/stress-testing/ConcentrationTab.tsx
  - pages/stress-testing/MigrationTab.tsx
  - pages/stress-testing/VintageTab.tsx
  - pages/stress-testing/CapitalImpact.tsx
"""
import pytest
