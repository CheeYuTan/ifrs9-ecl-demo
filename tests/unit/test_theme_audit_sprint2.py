"""
Sprint 2 Theme Audit — Regression Tests

Verify that the 8 Sprint 2 workflow page .tsx files have no dark-mode-only
...
# ── Tests (16 scanners × 8 files) ──────────────────────────────────────


@pytest.mark.parametrize("relpath", ALL_SPRINT2_FILES)
